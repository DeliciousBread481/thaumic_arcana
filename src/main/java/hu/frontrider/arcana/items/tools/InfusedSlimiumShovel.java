...
@Metadata(
   ...
   d2 = {"Lhu/frontrider/arcana/items/tools/InfusedSlimiumShovel;", "Lhu/frontrider/arcana/items/tools/ShovelBase;", "Lhu/frontrider/arcana/util/IInfuseable;", "()V", "addInformation", "", "stack", "Lnet/minecraft/item/ItemStack;", "worldIn", "Lnet/minecraft/world/World;", "tooltip", "", "", "flagIn", "Lnet/minecraft/client/util/ITooltipFlag;", "hasEffect", "", "Thaumic Arcana"}
)
public final class InfusedSlimiumShovel extends ShovelBase implements IInfuseable {
   ...
   public InfusedSlimiumShovel() {
      super("infused_slimy_shovel", MaterialsKt.getTOOL_MATERIAL_INFUSED_SLIMIUM());
   }
}
