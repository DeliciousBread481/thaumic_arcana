...
@Metadata(
   ...
   d2 = {"Lhu/frontrider/arcana/items/tools/LiviumAxe;", "Lhu/frontrider/arcana/items/tools/AxeBase;", "()V", "onItemRightClick", "Lnet/minecraft/util/ActionResult;", "Lnet/minecraft/item/ItemStack;", "worldIn", "Lnet/minecraft/world/World;", "playerIn", "Lnet/minecraft/entity/player/EntityPlayer;", "handIn", "Lnet/minecraft/util/EnumHand;", "Thaumic Arcana"}
)
public final class LiviumAxe extends AxeBase {
   @NotNull
   ...
   public LiviumAxe() {
      super("livium_axe", MaterialsKt.getTOOL_MATERIAL_LIVIUM());
   }
}
