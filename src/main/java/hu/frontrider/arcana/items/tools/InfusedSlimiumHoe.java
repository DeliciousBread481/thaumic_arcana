...
@Metadata(
   ...
   d2 = {"Lhu/frontrider/arcana/items/tools/InfusedSlimiumHoe;", "Lhu/frontrider/arcana/items/tools/HoeBase;", "Lhu/frontrider/arcana/util/IInfuseable;", "()V", "addInformation", "", "stack", "Lnet/minecraft/item/ItemStack;", "worldIn", "Lnet/minecraft/world/World;", "tooltip", "", "", "flagIn", "Lnet/minecraft/client/util/ITooltipFlag;", "hasEffect", "", "Thaumic Arcana"}
)
public final class InfusedSlimiumHoe extends HoeBase implements IInfuseable {
   ...
   public InfusedSlimiumHoe() {
      super("infused_slimy_hoe", MaterialsKt.getTOOL_MATERIAL_SLIMIUM());
   }
}
