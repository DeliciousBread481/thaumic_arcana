...
@Metadata(
   ...
   d2 = {"Lhu/frontrider/arcana/items/tools/InfusedSlimiumSword;", "Lhu/frontrider/arcana/items/tools/SwordBase;", "Lhu/frontrider/arcana/util/IInfuseable;", "()V", "addInformation", "", "stack", "Lnet/minecraft/item/ItemStack;", "worldIn", "Lnet/minecraft/world/World;", "tooltip", "", "", "flagIn", "Lnet/minecraft/client/util/ITooltipFlag;", "hasEffect", "", "Thaumic Arcana"}
)
public final class InfusedSlimiumSword extends SwordBase implements IInfuseable {
   ...
   public InfusedSlimiumSword() {
      super("infused_slimy_sword", MaterialsKt.getTOOL_MATERIAL_INFUSED_SLIMIUM());
   }
}
