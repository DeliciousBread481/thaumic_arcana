...
@Metadata(
   ...
   d2 = {"Lhu/frontrider/arcana/items/tools/LiviumShovel;", "Lhu/frontrider/arcana/items/tools/ShovelBase;", "()V", "onItemRightClick", "Lnet/minecraft/util/ActionResult;", "Lnet/minecraft/item/ItemStack;", "worldIn", "Lnet/minecraft/world/World;", "playerIn", "Lnet/minecraft/entity/player/EntityPlayer;", "handIn", "Lnet/minecraft/util/EnumHand;", "Thaumic Arcana"}
)
public final class LiviumShovel extends ShovelBase {
   @NotNull
   ...
   public LiviumShovel() {
      super("livium_shovel", MaterialsKt.getTOOL_MATERIAL_LIVIUM());
   }
}
