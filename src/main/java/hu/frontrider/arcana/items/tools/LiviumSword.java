...
@Metadata(
   ...
   d2 = {"Lhu/frontrider/arcana/items/tools/LiviumSword;", "Lhu/frontrider/arcana/items/tools/SwordBase;", "()V", "onItemRightClick", "Lnet/minecraft/util/ActionResult;", "Lnet/minecraft/item/ItemStack;", "worldIn", "Lnet/minecraft/world/World;", "playerIn", "Lnet/minecraft/entity/player/EntityPlayer;", "handIn", "Lnet/minecraft/util/EnumHand;", "Thaumic Arcana"}
)
public final class LiviumSword extends SwordBase {
   @NotNull
   ...
   public LiviumSword() {
      super("livium_sword", MaterialsKt.getTOOL_MATERIAL_LIVIUM());
   }
}
