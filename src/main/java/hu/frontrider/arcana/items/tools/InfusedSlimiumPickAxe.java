...
@Metadata(
   ...
   d2 = {"Lhu/frontrider/arcana/items/tools/InfusedSlimiumPickAxe;", "Lhu/frontrider/arcana/items/tools/PickAxeBase;", "Lhu/frontrider/arcana/util/IInfuseable;", "()V", "addInformation", "", "stack", "Lnet/minecraft/item/ItemStack;", "worldIn", "Lnet/minecraft/world/World;", "tooltip", "", "", "flagIn", "Lnet/minecraft/client/util/ITooltipFlag;", "hasEffect", "", "Thaumic Arcana"}
)
public final class InfusedSlimiumPickAxe extends PickAxeBase implements IInfuseable {
   ...
   public InfusedSlimiumPickAxe() {
      super("infused_slimy_pickaxe", MaterialsKt.getTOOL_MATERIAL_INFUSED_SLIMIUM());
   }
}
