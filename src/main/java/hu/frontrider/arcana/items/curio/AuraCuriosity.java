...
public final class AuraCuriosity extends ItemBase {
      ...
      if (!worldIn.field_72995_K) {
         ...
         switch (worldIn.field_73012_v.nextInt(5)) {
            case 1:
               ...
               break;
            case 2:
               ThaumcraftApi.internalMethods.addKnowledge(playerIn, EnumKnowledgeType.OBSERVATION, ResearchCategories.getResearchCategory("AUROMANCY"), MathHelper.func_76136_a(playerIn.func_70681_au(), oProg / 2, oProg));
               ThaumcraftApi.internalMethods.addKnowledge(playerIn, EnumKnowledgeType.THEORY, ResearchCategories.getResearchCategory("AUROMANCY"), MathHelper.func_76136_a(playerIn.func_70681_au(), tProg / 3, tProg / 2));
               break;
            default:
               ThaumcraftApi.internalMethods.addKnowledge(playerIn, EnumKnowledgeType.THEORY, ResearchCategories.getResearchCategory("AUROMANCY"), MathHelper.func_76136_a(playerIn.func_70681_au(), tProg / 3, tProg / 2));
         }
   ...
   public AuraCuriosity() {
      super("vaporous_curiosity");
   }
}
