...
public final class ScarProvider implements ICapabilitySerializable<NBTBase> {
   ...
   public boolean hasCapability(@NotNull Capability<?> capability, @Nullable EnumFacing facing) {
      ...
      Capability var10001 = SCARRED_CAPABILITY;
      if (var10001 == null) {
   ...
   public <T> T getCapability(@NotNull Capability<T> capability, @Nullable EnumFacing facing) {
      ...
      if (capability == var10001) {
         Capability var10000 = SCARRED_CAPABILITY;
         if (var10000 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("SCARRED_CAPABILITY");
         }
   ...
   public ScarProvider() {
      ...
      this.instance = (IScarred)var10001.getDefaultInstance();
   }

   // $FF: synthetic method
   @NotNull
   public static final Capability access$getSCARRED_CAPABILITY$cp() {
      Capability var10000 = SCARRED_CAPABILITY;
      if (var10000 == null) {
         Intrinsics.throwUninitializedPropertyAccessException("SCARRED_CAPABILITY");
      }
   ...
   public static final class Companion {
      ...
      public final void setSCARRED_CAPABILITY(@NotNull Capability<IScarred> var1) {
         Intrinsics.checkParameterIsNotNull(var1, "<set-?>");
         ScarProvider.SCARRED_CAPABILITY = var1;
      }
