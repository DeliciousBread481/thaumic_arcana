...
public final class CardDissectDead extends TheorycraftCard {
   ...
   public String getLocalizedName() {
      String var10000 = (new TextComponentTranslation("card.thaumic_arcana.study_dead_flesh.name", new Object[]{TextFormatting.DARK_BLUE.toString() + this.itemStack.func_82833_r() + TextFormatting.RESET + "" + TextFormatting.BOLD})).func_150254_d();
   ...
   public String getLocalizedText() {
      String var10000 = (new TextComponentTranslation("card.thaumic_arcana.study_dead_flesh.text", new Object[]{TextFormatting.DARK_BLUE.toString() + this.itemStack.func_82833_r() + TextFormatting.RESET})).func_150254_d();
   ...
   @Metadata(
      ...
      k = 1,
      d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0011\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R$\u0010\u0003\u001a\n\u0012\u0004\u0012\u00020\u0005\u0018\u00010\u0004X\u0080\u000e¢\u0006\u0010\n\u0002\u0010\n\u001a\u0004\b\u0006\u0010\u0007\"\u0004\b\b\u0010\t¨\u0006\u000b"},
      d2 = {"Lhu/frontrider/arcana/research/theory/CardDissectDead$Companion;", "", "()V", "options", "", "Lnet/minecraft/item/ItemStack;", "getOptions$Thaumic_Arcana", "()[Lnet/minecraft/item/ItemStack;", "setOptions$Thaumic_Arcana", "([Lnet/minecraft/item/ItemStack;)V", "[Lnet/minecraft/item/ItemStack;", "Thaumic Arcana"}
   )
   public static final class Companion {
      @Nullable
      public final ItemStack[] getOptions$Thaumic_Arcana() {
         return CardDissectDead.options;
      }

      public final void setOptions$Thaumic_Arcana(@Nullable ItemStack[] var1) {
         CardDissectDead.options = var1;
      }
