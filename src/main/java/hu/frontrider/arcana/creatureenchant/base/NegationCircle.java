...
@Metadata(
   ...
   d2 = {"Lhu/frontrider/arcana/creatureenchant/base/NegationCircle;", "Lhu/frontrider/arcana/creatureenchant/EnchantingBaseCircle;", "()V", "color", "Lhu/frontrider/arcana/creatureenchant/EnchantingBaseCircle$Color;", "getColor", "()Lhu/frontrider/arcana/creatureenchant/EnchantingBaseCircle$Color;", "formula", "Lthaumcraft/api/aspects/AspectList;", "kotlin.jvm.PlatformType", "getFormula", "()Lthaumcraft/api/aspects/AspectList;", "research", "", "getResearch", "()Ljava/lang/String;", "doEffect", "", "multiplier", "entityLiving", "Lnet/minecraft/entity/EntityLivingBase;", "enchant", "Lhu/frontrider/arcana/creatureenchant/CreatureEnchant;", "Thaumic Arcana"}
)
public final class NegationCircle extends EnchantingBaseCircle {
   @NotNull
   private final EnchantingBaseCircle.Color color = new EnchantingBaseCircle.Color(255, 0, 0, 255);
   ...
   public NegationCircle() {
      super("negation");
      this.formula = (new AspectList()).merge(Aspect.BEAST, 300).merge(Aspect.FLUX, 100).merge(Aspect.LIFE, 50).merge(Aspect.ENTROPY, 100);
      this.research = "ENCHANT_MODIFICATION";
      this.setRegistryName("thaumic_arcana", "negation");
   }
}
