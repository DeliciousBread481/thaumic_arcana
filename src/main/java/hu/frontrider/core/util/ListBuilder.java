...
@Metadata(
   ...
   d2 = {"Lhu/frontrider/core/util/ListBuilder;", "T", "", "list", "", "(Ljava/util/List;)V", "add", "element", "(Ljava/lang/Object;)Lhu/frontrider/core/util/ListBuilder;", "build", "", "print", "printer", "Lkotlin/Function1;", "", "Thaumic Arcana"}
)
